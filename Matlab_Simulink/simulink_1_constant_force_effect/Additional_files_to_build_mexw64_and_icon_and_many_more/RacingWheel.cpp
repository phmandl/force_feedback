 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Jul 08 09:47:14 2020
 */
...
/* Parameter 1 */
#define PARAMETER_1_NAME      Ts_Block
...
static void mdlStart(SimStruct *S)
{
    ...
    const real_T *Ts_Block = (const real_T *) mxGetData(PARAM_DEF1(S));
    
    RacingWheel_Start_wrapper(Ts_FF, p_width0, Ts_Block, p_width1);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    RacingWheel_Outputs_wrapper(FF, gearup, geardown, ST, SE, X, O, Square, Triangle, L2, R2, L3, R3, DPadDown, DPadUp, DPadLeft, DPadRight, throttle, brake, clutch, angle, Ts_FF, p_width0, Ts_Block, p_width1);
