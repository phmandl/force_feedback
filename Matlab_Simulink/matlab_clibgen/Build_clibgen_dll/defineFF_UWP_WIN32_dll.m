...
libDef.OutputFolder = "C:\Users\mandl\repos\uwp_force_feedback\Matlab_Simulink\matlab_clibgen\Build_clibgen_dll";
...
%% C++ class public data member |timestamp| for C++ class |wheelreadings| 
% C++ Signature: unsigned long long wheelreadings::timestamp
addProperty(WheelReadingsDefinition, "timestamp", "uint64", ...
    "Description", "uint64    Data member of C++ class wheelreadings"); % This description is shown as help to user. Modify it to appropriate description.
...
% C++ Signature: bool initRacingWheel()
...
%% C++ function |FF_zero| with MATLAB name |clib.FF_UWP_WIN32_dll.FF_zero|
% C++ Signature: void FF_zero()
FF_zeroDefinition = addFunction(libDef, ...
    "void FF_zero()", ...
    "MATLABName", "clib.FF_UWP_WIN32_dll.FF_zero", ...
    "Description", "clib.FF_UWP_WIN32_dll.FF_zero    Representation of C++ function FF_zero"); % This description is shown as help to user. Modify it to appropriate description.
validate(FF_zeroDefinition);
...
%% C++ function |kill_FF| with MATLAB name |clib.FF_UWP_WIN32_dll.kill_FF|
% C++ Signature: void kill_FF()
kill_FFDefinition = addFunction(libDef, ...
    "void kill_FF()", ...
    "MATLABName", "clib.FF_UWP_WIN32_dll.kill_FF", ...
    "Description", "clib.FF_UWP_WIN32_dll.kill_FF    Representation of C++ function kill_FF"); % This description is shown as help to user. Modify it to appropriate description.
validate(kill_FFDefinition);
