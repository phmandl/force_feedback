 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jul 07 22:56:38 2020
 */
...
#define NPARAMS               1
/* Parameter 0 */
#define PARAMETER_0_NAME      Ts_Block
#define PARAMETER_0_DTYPE     real_T
#define PARAMETER_0_COMPLEX   COMPLEX_NO

#define SAMPLE_TIME_0         Ts_Block
...
extern void RacingWheel_Start_wrapper(const real_T *Ts_Block, const int_T p_width0);
extern void RacingWheel_Outputs_wrapper(const real_T *FF_bias,
			boolean_T *gearup,
			boolean_T *geardown,
			boolean_T *ST,
			boolean_T *SE,
...
static void mdlCheckParameters(SimStruct *S)
{
...

    {
        ...
        if (!mxIsDouble(pVal0)) {
            ssSetErrorStatus(S, "Sample time parameter Ts_Block must be of type double");
            return;
        }
    }
...
static void mdlStart(SimStruct *S)
{
    ...
    const real_T *Ts_Block = (const real_T *) mxGetData(PARAM_DEF0(S));
    
    RacingWheel_Start_wrapper(Ts_Block, p_width0);
}
#endif /*  MDL_START */
...
{
    const real_T *FF_bias = (real_T *) ssGetInputPortRealSignal(S, 0);
    ...
    RacingWheel_Outputs_wrapper(FF_bias, gearup, geardown, ST, SE, X, O, Square, Triangle, L2, R2, L3, R3, DPadDown, DPadUp, DPadLeft, DPadRight, throttle, brake, clutch, angle, Ts_Block, p_width0);
